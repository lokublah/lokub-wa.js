...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const mess = {
            wait: '[ WAIT ]*Sedang di proses,Tunggu Sebentar...*',
            error: {
                St: '[❗] Kirim gambar dengan caption *!sticker* atau reply gambar yang sudah dikirim',
                Qm: '[❗] Terjadi kesalahan, mungkin themenya tidak tersedia!',
                Yt3: '[❗] Terjadi kesalahan, tidak dapat meng konversi ke mp3!',
                Yt4: '[❗] Terjadi kesalahan, mungkin error di sebabkan oleh sistem.',
                Ig: '[❗] Terjadi kesalahan, cek kembali penulisan!',
                Ki: '[❗] Bot tidak bisa mengeluarkan admin group!',
                Ad: '[❗] Tidak dapat menambahkan target, cek kembali penulisan!',
                Iv: '[❗] Link tidak valid!'
            }
        }
        ...
        const ownerNumber = '6281282810290,6285891482190@c.us'
        ...
        case '!gifsticker':
            if (isMedia) {
                if (mimetype === 'video/mp4' && message.duration < 10 || mimetype === 'image/gif' && message.duration < 10) {
                    const mediaData = await decryptMedia(message, uaOverride)
                    client.reply(from, '[WAIT] Sedang di proses...,jika lama coba kembali!', id)
        ...
        case '!nulis':
            ...
            break
        case '!ytmp3':
            if (args.length === 1) return client.reply(from, 'Kirim perintah *!ytmp3 [linkYt]*, untuk contoh silahkan kirim perintah *!tutor*')
        ...
        case '!fbdl':
            ...
            break
        case '!creator':
            client.sendContact(from, '621282810290@c.us')
            break
        case '!igdl':
        ...
        case '!welcome':
            ...
            if (args[1].toLowerCase() === 'enable') {
                ...
                client.reply(from, 'Pilih enable atau disable ramlih!', id)
            }
            break
        case '!nsfwmenu':
            if (!isNsfw) return
        ...
        case '!wait':
            if (isMedia && type === 'image' || quotedMsg && quotedMsg.type === 'image') {
                ...
                .then(resolt => {
                    ...
                    teks = ''
                    if (similarity < 0.92) {
                    	teks = '*Mungkin ini anime yang kamu maksud..* :\n\n'
                    }
        ...
        case '!bc':
            ...
            for (let ids of chatz) {
                ...
                if (!cvk.isReadOnly) await client.sendText(ids, `[ Lokub Place Broadcast ]\n\n${msg}`)
            }
        ...
        case '!join':
            ...
            if (check.size < minMem) return client.reply(from, 'Member group tidak melebihi 15, bot tidak bisa masuk', id)
            if (check.status === 200) {
        ...
        case '!getss':
            ...
            break
        case '!lirik':
        if (!isOwner) return client.reply(from,`Premium Only`, id)
        ...
        case '!listdaerah':
            ...
            break
        case '!listblock':
            let hih = `Nomor Nomor Orang Tolol\nTotal : ${blockNumber.length}\n`
        ...
        case '!jadwalshalat':
            ...
            const resultJadwal = `Berikut adalah jadwal shalat di ${daerah}, ${tgl}-${arrbulan[bln]}-${thn}\n\nImsyak : ${Imsyak}\nSubuh : ${Subuh}\nDhuha : ${Dhuha}\nDzuhur : ${Dzuhur}\nAshar : ${Ashar}\nMaghrib : ${Maghrib}\nIsya : ${Isya}`
        ...
        case '!loli':
            ...
            client.sendFileFromUrl(from, loli.result, 'loli.jpeg', 'Awas ada pedofil', id)
            break
        case '!waifu':
